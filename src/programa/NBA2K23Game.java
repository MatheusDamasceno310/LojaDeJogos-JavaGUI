 ...
 * @author mathe
 */
public class NBA2K23Game extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/NBA2K23/32469.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/NBA2K23/NBA-2K23-8-900x503.jpg"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/NBA2K23/nba-2k23-giannis-antetokoumpo-rating.jpg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/NBA2K23/NBA-2K23-Booker-Screenshot.jpg"))); // NOI18N
        ...
        jTextArea1.setText("Uma Jornada Épica À Sua Espera. Embarque em uma aventura do basquete a bordo de um espaçoso cruzeiro equipado com quadras excelentes, vistas panorâmicas e muitas recompensas para você e seu MyPLAYER aproveitarem. Além disso, há ainda mais para explorar durante as expedições em terra firme.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("NBA 2K23");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/NBA2K23/nba-2k23-next-gen-version_ej55.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NBA2K23Game.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NBA2K23Game().setVisible(true);
            }
        });
    }
