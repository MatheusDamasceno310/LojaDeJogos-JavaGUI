 ...
 * @author mathe
 */
public class ResidentEvil4Game extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ResidentEvil4Game
     */
    public ResidentEvil4Game() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ResidentEvil4/images (4) (4).jpeg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ResidentEvil4/images (5) (3).jpeg"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ResidentEvil4/images (8).jpeg"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ResidentEvil4/ss_254ff088257d644c493be6735bc75caf0f8930c7.1920x1080.jpg"))); // NOI18N
        ...
        jTextArea1.setText("Minecraft é um jogo eletrônico dos gêneros sandbox e sobrevivência que não possui objetivos específicos a serem alcançados, permitindo aos jogadores uma grande liberdade de escolha de como jogá-lo. No entanto, existe um sistema de conquistas, conhecido como \"progressos\" na edição Java.\n");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Resident Evil 4");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ResidentEvil4/images (2) (5).jpeg"))); // NOI18N
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
        ...
        compra.setNomeDoJogo("Resident Evil 4");
        compra.setValorAPagar("39,99");
        compra.email = email;
        compra.senha = senha;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResidentEvil4Game.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResidentEvil4Game().setVisible(true);
            }
        });
    }
