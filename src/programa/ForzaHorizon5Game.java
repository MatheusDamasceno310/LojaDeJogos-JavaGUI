 ...
 * @author mathe
 */
public class ForzaHorizon5Game extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ForzaHorizon5Game
     */
    public ForzaHorizon5Game() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ForzaHorizon5/capsule_616x353.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ForzaHorizon5/536161-thumb-serp-1200x675.jpg"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ForzaHorizon5/Forza Horizon 5 (15).png"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ForzaHorizon5/1188900.jpg"))); // NOI18N
        ...
        jTextArea1.setText("Ambientado no México, o jogador poderá escolher em qual ordem participar das corridas e explorar um vasto mapa, cheio de atividades, como: desafios de perícia, descobrir carros escondidos e etc.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Forza Horizon 5");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ForzaHorizon5/60c8063560178.jpg"))); // NOI18N
    ...
    private void btnCarrinhoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCarrinhoActionPerformed
        ...
        do {
            ...
            if(jogo[c] == null) {
                ...
                jogo[c] = "Forza Horizon 5";
                preco[c] = (float) 249.99;
                condicao = 1;
            }
            c++;
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
        ...
        compra.setNomeDoJogo("Forza Horizon 5");
        compra.setValorAPagar("249,99");
        compra.email = email;
        compra.senha = senha;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForzaHorizon5Game.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ForzaHorizon5Game().setVisible(true);
            }
        });
    }
